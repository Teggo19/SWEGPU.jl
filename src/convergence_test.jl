...
function convergence_test(baseline, baseline_n, N_list, T, initial_function, title; backend="cpu", bc=neumannBC, reconstruction=0)
    ...
    lines!(ax1, N_list, diffs, color=:blue, label="L1 error")
    scatter!(ax1, N_list, diffs, color=:blue, markersize=10)
